...
<#--        <@blogHeader title="关于社区"></@blogHeader>-->
        <div class="col-sm-12 blog-main">
            <div class="blog-body expansion">
                <h5 class="custom-title"><i class="fa fa-user-secret fa-fw"></i><strong>社区简介</strong><small></small></h5>
                <div class="info">
                    <p>
                        <strong>该社区致力于为Java初学者提供优质的学习文章，提供一个高质量的学习社区，减低大家在学习Java茫然而而浪费的时间。</strong>
                    </p>
                </div>
...
<#--                </div>-->
                ...
                <div class="info">
                    ...
                    <br>
                    所有转载的文章皆来源于互联网，若因此对原作者造成侵权，烦请原作者<strong>告知(smdam@163.com)</strong>，我会立刻删除相关内容。
                </div>
                <@praise></@praise>
            </div>
        </div>
