    ...
    <div class="menu-box">
        ...
        <div class="menu-topmenu-container pull-right">
            <ul class="list-unstyled list-inline pull-left">
                <li><a href="${config.siteUrl}/about" class="menu_a" title="关于社区" data-toggle="tooltip" data-placement="bottom">关于社区</a></li>
            ...
            <div class="pull-left site-desc">
                <div class="logoo">
                    <a href="${config.siteUrl}">
                        <img src="${config.staticWebSite}/img/javalogo.png">
                    </a>
                </div>
                <h2 class="auto-shake">
                    <a class="descc" href="${config.siteUrl}" data-original-title="${config.siteDesc}" data-toggle="tooltip" data-placement="bottom">${config.siteDesc}
                    </a>
                </h2>
