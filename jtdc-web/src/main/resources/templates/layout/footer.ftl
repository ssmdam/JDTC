...
<#--                        <li><a href="${config.siteUrl}/updateLog" title="更新记录" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-file-o fa-fw"></i>更新记录</a></li>-->
                ...
                <p><a href="http://localhost:8085" target="_blank" title="Java技术开发社区后台" data-toggle="tooltip" data-placement="bottom" rel="external nofollow">系统后台</a> </p>
                <p>Java技术开发社区 | <a href="/" title="一个学习Java的宝地" data-toggle="tooltip" data-placement="right" target="_blank"><i>一个学习Java的宝地</i></a>  </p>
                <#if url?? && (url == "index")>
