<#-- 公共顶部 -->
<#macro header title="Java技术开发社区" keywords="" description="" canonical="" hasEditor=false>
...
<head>
    ...
    <meta name="baidu-site-verification" content="gEWHgRayML" />
    ...
    <link href="/assets/css/my.main.css" rel="stylesheet">
