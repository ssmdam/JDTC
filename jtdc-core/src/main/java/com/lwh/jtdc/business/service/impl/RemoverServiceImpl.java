...
import com.lwh.jtdc.business.util.ImageDownloadUtil;
...
import com.lwh.jtdc.business.service.BizTagsService;
...
public class RemoverServiceImpl implements RemoverService {
    ...
    public void run(Long typeId, @Validated HunterConfig config, PrintWriter writer) {
        ...
        writerUtil.print(String.format("爬取完成！耗时 %s ms.", (System.currentTimeMillis() - start)));
        writerUtil.shutdown();
    }
