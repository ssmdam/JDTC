                    ...
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                            ...
                            <li role="presentation">
                                <a href="#single" id="single-tab" role="tab" data-toggle="tab" aria-expanded="true"><i></i>抓取单个文章</a>
                            </li>
                        </ul>
                                            ...
                                            <div class="x_content">
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-9 col-sm-9 col-xs-9 tips">
                                                        <i class="fa fa-exclamation-circle"></i> 勾选转载图片即可将图片存储到本地存储
                                                    </div>
                                                </div>
                                                <div class="item form-group">
...
<#--                                                </div>-->
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-9 col-sm-9 col-xs-9 tips">
                                                        ...
                                                        <ul class="list-unstyled">
                                                            <li><strong>默认：</strong>不做限制，抓取所有匹配到的文章</li>
                                                            <li><strong>持续时间：</strong>爬虫运行时间，一般是1s一条</li>
                                                ...
                                                <div class="item form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-3"></label>
                                                    <div class="col-md-9 col-sm-9 col-xs-9 tips">
                                                        <i class="fa fa-exclamation-circle"></i> 需要登录时设置。
<#--                                                        Cookie获取方式： <a href="javascript:HandlerInterceptor;" data-toggle="modal" data-target="#helpModal" data-img="/assets/images/spider/cookie/cookie.png" data-title="“Cookie”获取方式（通用）">以CSDN为例</a>-->
                                                    </div>
                                                </div>
                                                <div class="item form-group">
                                                ...
                                                <div class="item form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-3" for="entryUrls">爬虫入口 <span class="required">*</span></label>
                                                    <div class="col-md-9 col-sm-9 col-xs-9">
                                    ...
                                    <div class="col-md-12">
                                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#declareModal"><i> 开始爬取</i></button>
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="single" aria-labelledby="single-tab">
                                <form id="removerSingleForm" action="/remover/single" target="spiderFrame" method="post" class="form-horizontal form-label-left" novalidate>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-9">
                                            <button type="button" class="btn btn-success" id="crawlSingle"><i> 开始爬取</i></button>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
<div class="modal fade" id="declareModal" tabindex="-1" role="dialog" aria-labelledby="declareModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="declareModalTitle">提醒</h4>
            </div>
            <div class="modal-body">
                <ul class="list-unstyled">
                    <li><h1 align="center"><strong>请合法转载，小心侵权!</strong></h1></li>
                </ul>
            </div>
            <div class="modal-footer">
                <a type="button" class="btn btn-success" id="submitBtn"><i> 继续爬取</i></a>
                <a href="javascript:;" data-dismiss="modal"><i class="fa fa-close"> 取消</i></a>
            </div>
        </div>
    </div>
</div>
