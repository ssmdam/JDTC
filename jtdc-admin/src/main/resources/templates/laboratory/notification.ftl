    ...
    <div class="row">
        <div class="col-md-12">
            <@breadcrumb>
                <ol class="breadcrumb">
                    <li><a href="/">首页</a></li>
                    <li class="active">websocket通知</li>
                </ol>
            </@breadcrumb>
            <div class="x_panel">
                <div class="x_title">
                    <h2>向web端发送消息通知 <small>socket通信，当前在线: ${online!("0")}</small></h2>
                ...
                <form class="form-horizontal form-label-left" novalidate>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <button type="button" class="btn btn-primary" id="send-btn"><i class="fa fa-send"> 发送</i></button>
                        </div>
                    </div>
                </form>
