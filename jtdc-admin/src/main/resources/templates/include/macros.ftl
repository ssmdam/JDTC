...
<head>
    ...
    <title>${config.siteDesc}后台管理系统</title>
    <link href="/static/assets/images/favicon.ico" rel="shortcut icon" type="image/x-icon">
        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="/" class="site_title"><span>${config.siteDesc}后台</span></a>
    ...
    <#if footerHtml>
        <footer>
            <div class="pull-right">
                ...
                Java Technology Development Dommunity by <a href="https://localhost:8443">JTDD</a>
            </div>
            <div class="clearfix"></div>
        </footer>
    </#if>
...
<#--                                <a href="javascript:void(0)" rel="bookmark">Java技术开发社区后台</a>-->
<#--                            </li>-->
<#--                        </ul>-->
<#--                    </div>-->
<#--                </div>-->
